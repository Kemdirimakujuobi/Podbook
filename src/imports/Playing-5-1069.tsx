import svgPaths from "./svg-eo6gzb6faz";
import imgImage33 from "figma:asset/fc08b86159a859fa7cb161330ecdb9059ec30392.png";
import { imgEllipse1, imgTextBlockMask } from "./svg-y84om";
...
function HeaderContainsLogoOfSource() {
  return (
    <div className="h-[56px] relative shrink-0 w-full" data-name="Header - Contains logo of source">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex gap-[8px] h-[56px] items-center px-[40px] py-[8px] relative w-full">
          <MaskGroup />
        </div>
      </div>
    </div>
  ...
  return (
    <div className="basis-0 grow min-h-px min-w-px relative shrink-0 w-full">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex gap-[8px] items-start px-[40px] py-0 relative size-full">
          <MetaLockup />
        </div>
      </div>
    </div>
...
function Frame() {
  return (
    <div className="[grid-area:1_/_1] box-border content-stretch flex gap-px items-end ml-0 mt-0 relative w-[822px]">
...
function MaskGroup1() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0 w-full" data-name="Mask group">
      <Frame />
      <div className="[grid-area:1_/_1] bg-[rgba(190,163,156,0.34)] h-[68px] ml-0 mt-[-8px] w-[822px]" data-name="Full mask" />
      <div className="[grid-area:1_/_1] bg-[#dc8069] h-[68px] ml-0 mt-[-8px] opacity-30 w-[389px]" data-name="Hover mask" />
      <div className="[grid-area:1_/_1] bg-[#dc8069] h-[68px] ml-0 mt-[-8px] w-[337.643px]" data-name="Current Progress Mask" />
    </div>
  );
}

function Frame3() {
  return <div className="absolute left-[419px] size-[24px] top-[21px]" />;
}
...
function Scrubber() {
  return (
    <div className="relative shrink-0 w-full" data-name="Scrubber">
      <div className="flex flex-col items-end justify-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex flex-col gap-[8px] items-end justify-center px-[40px] py-0 relative w-full">
          <MaskGroup1 />
          <Frame3 />
          <TrackerOnHover />
        </div>
...
function TopSection() {
  return (
    <div className="h-[434px] relative shrink-0 w-full" data-name="Top section">
      <div className="flex flex-col items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex flex-col gap-[8px] h-[434px] items-center justify-center px-[414px] py-0 relative w-full">
...
function LiveTranscriptOnPlay() {
  return (
    <div className="absolute contents left-[calc(50%-0.5px)] top-[52px] translate-x-[-50%]" data-name="Live Transcript - On play">
      <div className="absolute bg-[#c0b5b3] bottom-[47.21%] left-[calc(50%-0.5px)] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[20.576px_43.271px] mask-size-[468.402px_150.633px] top-[2.79%] translate-x-[-50%] w-[511px]" data-name="Text Block Mask" style={{ maskImage: `url('${imgTextBlockMask}')` }} />
      <div className="absolute bg-[#221a18] bottom-[74.46%] left-[calc(50%-0.5px)] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[20.576px_43.271px] mask-size-[468.402px_150.633px] top-[2.79%] translate-x-[-50%] w-[511px]" data-name="Current Words Mask" style={{ maskImage: `url('${imgTextBlockMask}')` }} />
    </div>
  );
}
...
function Playtime() {
  return (
    <div className="absolute content-stretch flex font-['Inter:Regular',sans-serif] font-normal items-center justify-between leading-[20px] left-[454px] not-italic text-[14px] text-[rgba(34,25,23,0.54)] text-nowrap top-[8px] w-[822px] whitespace-pre" data-name="Playtime">
...
function BottomSection() {
  return (
    <div className="basis-0 bg-white grow min-h-px min-w-px overflow-clip relative shadow-[0px_2px_4px_-1px_rgba(1,19,69,0.04),0px_1px_2px_0px_rgba(1,19,69,0.11),0px_0px_0px_1px_rgba(1,19,69,0.06)] shrink-0 w-full" data-name="Bottom Section">
...
function Frame1() {
  return (
    <div className="absolute content-stretch flex flex-col h-[900px] items-start left-[-2px] top-0 w-[1730px]">
      <TopSection />
      <BottomSection />
    </div>
  );
