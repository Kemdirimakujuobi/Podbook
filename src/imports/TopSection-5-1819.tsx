  ...
  return (
    <div className="basis-0 grow min-h-px min-w-px relative shrink-0 w-full">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex gap-[8px] items-start pb-0 pt-[8px] px-[40px] relative size-full">
          <MetaLockup />
        </div>
      </div>
    </div>
...
function Frame() {
  return (
    <div className="[grid-area:1_/_1] box-border content-stretch flex gap-px items-end ml-0 mt-0 relative w-[534px]">
...
function MaskGroup1() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0 w-full" data-name="Mask group">
      <Frame />
      <div className="[grid-area:1_/_1] bg-[rgba(190,163,156,0.34)] h-[68px] ml-0 mt-[-8px] w-[534px]" data-name="Full mask" />
      <div className="[grid-area:1_/_1] bg-[#dc8069] h-[68px] ml-0 mt-[-8px] opacity-30 w-[242px]" data-name="Hover mask" />
      <div className="[grid-area:1_/_1] bg-[#dc8069] h-[68px] ml-0 mt-[-8px] w-[219.345px]" data-name="Current Progress Mask" />
    </div>
  );
}
