  ...
  return (
    <div className="relative size-full" data-name="Top section">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="box-border content-stretch flex flex-col gap-[8px] items-center justify-center px-[414px] py-0 relative size-full">
