import svgPaths from "./svg-b4qex2gqcs";
import imgImage33 from "figma:asset/fc08b86159a859fa7cb161330ecdb9059ec30392.png";
import { imgEllipse1, imgTextBlockMask } from "./svg-mfklz";
...
function BottomSection() {
  return (
    <div className="basis-0 bg-white grow min-h-px min-w-px relative shadow-[0px_2px_4px_-1px_rgba(1,19,69,0.04),0px_1px_2px_0px_rgba(1,19,69,0.11),0px_0px_0px_1px_rgba(1,19,69,0.06)] shrink-0 w-full" data-name="Bottom Section">
      <div className="flex flex-col items-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex flex-col gap-[32px] items-center px-[414px] py-[8px] relative size-full">
          <Playtime />
          <Frame3 />
        </div>
      </div>
...
function MainContainer() {
  return (
    <div className="absolute content-stretch flex flex-col h-[900px] items-start left-0 top-0 w-[1728px]" data-name="Main container">
      <TopSection />
      <BottomSection />
    </div>
  );
